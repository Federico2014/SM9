...
/*
   Check if BNPoint2 is zero, return 1 if zero, otherwise return 0
 */
...
void P2_twice(BNPoint2 *p, BNPoint2 q)
{
	...
	else
	{
		...
		F2_square(&t4,t3);       // Correction needed
...
/*
Check if point is on BN twist curve y^2 = x^3 + 5u z^6
*/
...
/*
   Print BNPoint2 in decimal or hexadecimal
 */
