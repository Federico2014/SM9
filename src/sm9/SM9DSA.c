...
void DSA_Demo()
{
	...
	printf("\n********************************************\n");
	printf("*********SM9 Digital Signature Demo*********** \n");
	printf("********************************************\n");
	printf("***********************\n");
	printf("****1. Key generation phase****\n");
	printf("***********************\n");
	printf("Generator P1 in G1 = \n");
	P_toString(P1,HEX);
	printf("Generator P2 in G2 = \n");
	P2_toString(P2,HEX);
	printf("Signer private key ks = %s\n",Put(ks,HEX));
	printf("Signer public key P_pub_s = [ks]P2 = \n");
	P2_toString(P_pub_s,HEX);
	printf("Entity A identifier IDA: %s\n",id);
	printf("Signer private key dsA = \n");
	P_toString(dsA,HEX);
	printf("\n***********************\n");
	printf("****2. Signature phase****\n");
	printf("***********************\n");
	printf("Message M to sign: %s\n",M);
	printf("Signature on M (h,S): \n");
	printf("h = %s\n",Put(h,HEX));
	printf("S = \n");
	P_toString(S,HEX);
	printf("\n***************************\n");
	printf("****3. Signature verification phase****\n");
	printf("***************************\n");
	printf("h2 = %s\n",Put(h2,HEX));
	if(sign)
		printf("h2 = h, signature verified successfully\n");
	else
		printf("h2 != h, signature verification failed\n");

	printf("\nSM9 digital signature key generation time: %f ms\n",time1);
	printf("SM9 digital signature time: %f ms\n",time2);
	printf("SM9 digital signature verification time: %f ms\n",time3);
}
/*
   dsA: Generated private key
   ks: Master private key
   ID: User ID string
...
/*
 h,S: Generated digital signature
 M: Message to be signed
 P1: Generator element
 P_pub: Public key
 dsA: Signer's private key
*/
void DSA_Sign(CBigInt *h, BNPoint *S, BYTE *M, BNPoint P1, BNPoint2 P_pub, BNPoint dsA)
{
	...
	len2 = len1 + 384;  // A 12th extension field element requires 32*12 = 384 bytes
