...
/*	printf("BN.t = %s\n",Put(BN.t,DEC));
	...
	*/
	...
	//  KA_Demo();
	//   KEM_demo();
	  PKC_demo(1); // 0 = stream mode, 1 = block mode
...
/*
   ...
   */	
 /*
	   // Verify R(kt*Q,ks*P) = R(Q,P)^(kt*ks)
       mpz_init_set_str(ks,"0130E78459D78545CB54C587E02CF480CE0B66340F319F348A1D5B1F2DC5F4",16);
